...
Para entender a relação do salário dos executivos em função dos anos de experiência e anos de trabalho separado por sexo, apresentamos na Figura \ref{fig:anos_sal} o gráfico de dispersão entre o salário e os anos de experiência entre homens e mulheres,o gráfico de boxplot do salário para cada posição na empresa e por fim, o gráfico de boxplot do salário separado por sexo na Figura \ref{fig:sex_sal}.
...
```{r sex_sal, fig.width= 4, fig.height=3, fig.pos="center", fig.cap="bla bla"}
dados %>% 
...
```{r anos_sal, fig.width=6, fig.height=3}
dados %>%
...
kable(calc.estat.mod.comp.MRNLH(modelo1))
```
