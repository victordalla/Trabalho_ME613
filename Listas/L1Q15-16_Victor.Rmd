...
```{r, fig.cap="Boxplot da variação do consumo de oxigênio (VO2) para cada etiologia.\\label{fig:boxplot}"}
...
```{r, fig.cap="Gráfico de dispersão da variação do consumo de oxigênio (VO2) em função da carga utilizada na esteira para cada etiologia.\\label{fig:dispersao}"}
...
\begin{tabular}{lcccc}
\hline
Termo             & Estimativa & EP    & p-valor          & IC(95\%)             \\ \hline
(Intercept)       & 15,351     & 0,490 & \textless{}0,001 & {[}14,380; 16,323{]} \\
etiologiaCH       & 0,409      & 0,727 & 0,575            & {[}-1,031; 1,849{]}  \\
etiologiaID       & -1,890     & 0,732 & 0,011            & {[}-3,341; -0,438{]} \\
etiologiaIS       & -1,257     & 0,806 & 0,122            & {[}-2,854; 0,341{]}  \\
carga             & 0,102      & 0,011 & \textless{}0,001 & {[}0,080; 0,125{]}   \\
etiologiaCH:carga & 0,039      & 0,021 & 0,066            & {[}-0,003; 0,082{]}  \\
etiologiaID:carga & -0,023     & 0,021 & 0,262            & {[}-0,064; 0,018{]}  \\
etiologiaIS:carga & -0,022     & 0,024 & 0,375            & {[}-0,070; 0,027{]}  \\
\hline
\end{tabular}
\end{table}
...
\hline
Termo       & Estimativa & EP    & p-valor          & IC(95\%)             \\ \hline
(Intercept) & 15,356     & 0,463 & \textless{}0,001 & {[}14,439; 16,272{]} \\
etiologiaCH & 0,198      & 0,722 & 0,784            & {[}-1,232; 1,629{]}  \\
etiologiaID & -1,579     & 0,718 & 0,030            & {[}-3,001; -0,156{]} \\
etiologiaIS & -0,917     & 0,761 & 0,231            & {[}-2,424; 0,591{]}  \\
carga       & 0,102      & 0,008 & \textless{}0,001 & {[}0,086; 0,118{]}   \\
\hline
\end{tabular}
\end{table}
...
Portanto, é preciso um modelo mais adequado para esta análise. Uma sugestão é o uso de uma distribuição contínua com suporte postivo (e.g. Gama) que descreva melhor a variável resposta (consumo de oxigênio), que pode ser modelado através de Modelos Lineares Generalizados.
