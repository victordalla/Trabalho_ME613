...
A Figura \ref{fig:pred}} apresenta o gráfiCo do VO2 em função da carga, a reta ajustada e o intervalo de confiança para as predições a 95\% (área em torno da reta). Poucos pontos ficam fora do intervalo de predição - a maior parte acompanha bem a reta.
