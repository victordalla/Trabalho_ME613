...
#Gráfico de dispersão para o preço de venda dos imóveis em função da área construída (are_cons), área do terreno (area_ter), idade e imposto.
...
#Gráfico da matriz de correlação das covariáveis área construída (are_cons), área do terreno (area_ter), idade e imposto. Quanto mais vermelho, mais positiva a correlação; quanto mais azul, mais negativa.
GGally::ggcorr(df)
```
...
$\beta_0$ & 38,50     & 0,785 & \textless{}0,001 & {[}36,87; 40,13{]} \\
$\beta_1$ & 5,99      & 1,594 & 0,001            & {[}2,69; 9,29{]}   \\
$\beta_2$ & 0,56      & 1,218 & 0,651            & {[}-1,97; 3,08{]}  \\
$\beta_3$ & 7,80      & 1,623 & \textless{}0,001 & {[}4,44; 11,17{]}  \\
$\beta_4$ & -0,61     & 0,931 & 0,516            & {[}-2,55; 1,32{]}  \\ \hline
\end{tabular}
\end{table}
...
\hline
Termo     & Estimativa & EP    & p-valor          & IC(95\%)           \\ \hline
$\beta_0$ & 38,50      & 0,771 & \textless{}0,001 & {[}36,91; 40,09{]} \\
$\beta_1$ & 6,08       & 1,553 & 0,001            & {[}2,87; 9,30{]}   \\
$\beta_3$ & 8,09       & 1,466 & \textless{}0,001 & {[}5,06; 11,13{]}  \\
$\beta_4$ & -0,74      & 0,875 & 0,406            & {[}-2,55; 1,07{]} 
\end{tabular}
\end{table}
...
\begin{table}[h]
\centering
\caption{Resultados do Modelo 3.}
\label{tab:modelo3}
\begin{tabular}{lcccc}
\hline
Termo     & Estimativa & EP    & p-valor          & IC(95\%)           \\ \hline
$\beta_0$ & 38,50      & 0,776 & \textless{}0,001 & {[}36,92; 40,08{]} \\
$\beta_1$ & 6,62       & 1,409 & \textless{}0,001 & {[}3,71; 9,53{]}   \\
$\beta_2$ & 7,78       & 1,409 & \textless{}0,001 & {[}4,87; 10,69{]} 
\end{tabular}
\end{table}
...
#Gráfico da predição \textit{versus} preço observado. A reta é a reta ajustado pelo Modelo 3. A banda ao redor da reta é o intervalo de confiança para as predições a 95\\%.
plot_prediction(modelo_reduzido, df$preco, "preço")
```

```{r, fig.cap="\\label{fig:resid}"}
#Análise dos resíduos (studentizados) do Modelo 3.
