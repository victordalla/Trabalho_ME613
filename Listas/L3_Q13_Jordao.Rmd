...
Sendo assim, um segundo modelo é proposto:
...
A Tabela \ref{tab:m2} contém os resultados do ajuste desse modelo. É possível observar que o coeficiente da covariável do uso de dentrifício não foi significante (0,73, muito maior que $\alpha=0,05$), assim como no modelo anterior, e será removido, um indício de que não há diferença com a utilização de dentrifício.
